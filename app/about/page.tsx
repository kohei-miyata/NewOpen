...
const FAQS = [
  ...
  { q: "会員登録しないと使えませんか？", a: "店舗情報の閲覧は会員登録不要です。クーポンの使用・いいね機能をご利用の場合は無料会員登録が必要です。" },
  { q: "掲載されない店舗はありますか？", a: "風俗・アダルト関連など、公序良俗に反する店舗は掲載をお断りしています。詳しくは利用規約をご確認ください。" },
  { q: "希望するカテゴリがない場合はどうすればいいですか？", a: "現在対応していないカテゴリへのご要望はお問い合わせよりご連絡ください。ご要望を参考に随時追加を検討いたします。" },
];
