    ...
    return (
      <div className="bg-gray-50 min-h-screen flex items-center justify-center px-4">
        <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 max-w-sm w-full text-center space-y-4">
          ...
          <h1 className="text-xl font-bold text-gray-900">パスワードを変更しました</h1>
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-md mx-auto px-4 py-12">
        <div className="mb-6">
          <Link href="/mypage" className="text-sm text-gray-500 hover:text-orange-500 transition-colors">← マイページに戻る</Link>
        </div>
        <h1 className="text-2xl font-bold text-gray-900 mb-6">パスワードを変更する</h1>
