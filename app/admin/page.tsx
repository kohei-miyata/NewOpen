                ...
                <tr key={u.id} className={`hover:bg-gray-50 ${isBanned ? "opacity-60" : ""}`}>
                  <td className="px-4 py-3 text-gray-800 max-w-[192px]">
                    {u.user_metadata?.line_user_id ? (
                      ...
                      <span className="flex items-center gap-1.5">
                        <span className="shrink-0 text-xs bg-white border border-gray-300 text-gray-600 px-1.5 py-0.5 rounded font-medium flex items-center gap-0.5">
                          <svg width="10" height="10" viewBox="0 0 24 24" aria-hidden="true" className="shrink-0">
